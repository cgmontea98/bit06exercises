...
function hola(e) {
  ...
  if (ed >= 18) {
    aler(`Bienvenido ${nom} ${ape}, su edad es ${ed} por lo tanto es mayor`);
  } else {
...
let btn17 = Array.from(document.querySelectorAll(".vm17"));
